...
async function importCriticalTables() {
  try {
    ...
    const slashCriticals = require('../data/slash-criticals-json');
    const crushCriticals = require('../data/crush-criticals-json');
    const punctureCriticals = require('../data/puncture-criticals-json');
    const lightningCriticals = require('../data/lightning-criticals-json');
